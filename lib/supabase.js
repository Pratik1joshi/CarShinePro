...
const mockProducts = [
  {
    ...
    description: "Professional grade car shiner that gives your vehicle a brilliant, long-lasting shine. Perfect for all paint types.",
    price: 29.99,
    originalPrice: null,
    image: "/placeholder.svg?height=300&width=300", // Keep single image for backwards compatibility
    images: [
      "/placeholder.svg?height=600&width=600",
      "/placeholder.svg?height=600&width=600&variant=1",
      "/placeholder.svg?height=600&width=600&variant=2",
      "/placeholder.svg?height=600&width=600&variant=3"
    ],
    category: "shiner",
    rating: 4.8,
    reviews: 124,
  ...
  },
  {
    ...
    description: "Advanced ceramic coating that provides ultimate protection against scratches, UV rays, and environmental damage.",
    price: 89.99,
    originalPrice: null,
    image: "/placeholder.svg?height=300&width=300", // Keep single image for backwards compatibility
    images: [
  ...
  },
  {
    ...
    description: "Powerful yet gentle cleaner that removes dirt, grime, and contaminants without damaging your car's finish.",
    price: 24.99,
    originalPrice: null,
    image: "/placeholder.svg?height=300&width=300", // Keep single image for backwards compatibility
    images: [
  ...
  },
  {
    ...
    description: "Complete car care package including Premium Shiner, Ceramic Coating, Deep Cleaner, and a professional detailing brush.",
    price: 129.99,
