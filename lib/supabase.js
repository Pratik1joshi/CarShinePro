...
const mockProducts = [
  ...
  },
  {
    ...
    shortId: "2",  // Simplified ID for easy access
    name: "Nodi Shine Waterless Auto Guard",
    description: "Advanced waterless car wash and protection spray. Cleans, shines, and protects your vehicle's paint without water. Perfect for quick touch-ups and regular maintenance.",
    price: 799, // NPR pricing
    originalPrice: null,
    image: "/products/nodi-shine-waterless3.png", // Real product image
    images: [
      "/products/nodi-shine-waterless3.png",
      "/products/nodi-shine-waterless.jpg",
      "/products/nodi-shine-waterless-2.jpg",
  ...
  },
  {
    ...
    shortId: "3",  // Simplified ID for easy access
    name: "Nodi Shine Stain Remover",
    description: "Powerful stain remover that effectively removes stubborn stains, dirt, and grime from car interiors and exteriors. Safe for all surfaces including fabric, leather, and vinyl.",
    price: 499, // NPR pricing
    originalPrice: null,
    image: "/products/nodi-shine-remover-3.png", // Real product image
    images: [
      "/products/nodi-shine-remover-3.png",
      "/products/nodi-shine-stain-remover-2.jpg",
      "/products/nodi-shine-stain-remover.jpg",
      "/products/image (3).webp"
    ],
    category: "cleaner",
    rating: 4.7,
    reviews: 156,
  ...
  },
  {
    ...
    shortId: "5",  // New product
    name: "Star Gold Dashboard & Vinyl Leather Shiner",
    description: "Premium dashboard and leather care product that cleans, shines, and protects all interior surfaces. Ideal for dashboards, vinyl, and leather upholstery.",
    price: 649, // NPR pricing
    originalPrice: null,
    image: "/products/star-gold-dashboard.jpg", // Real product image
    images: [
      "/products/star-gold-dashboard.jpg",
      "/products/star-gold-dashboard-2.jpg",
      "/products/star-gold-dashboard-3.jpg",
      "/products/star-gold-dashboard-4.jpg"
    ],
    category: "shiner",
    rating: 4.8,
    reviews: 98,
  ...
  },
  {
    ...
    shortId: "6",  // New product
    name: "Star Gold Body Glass Cleaner",
    description: "Professional glass and body cleaner that provides crystal clear finish. Removes water spots, dirt, and grime from glass, mirrors, and painted surfaces.",
    price: 549, // NPR pricing
    originalPrice: null,
    image: "/products/star-gold-glass.jpg", // Real product image
    images: [
      "/products/star-gold-glass.jpg",
      "/products/star-gold-glass-2.jpg",
      "/products/star-gold-glass-3.jpg",
      "/products/star-gold-glass-4.jpg"
    ],
    category: "spray",
    rating: 4.6,
    reviews: 73,
